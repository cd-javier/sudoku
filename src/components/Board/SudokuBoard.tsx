...
import type { Cell, Modes } from '../../utils/sudoku';
...
type CellProps = {
  cell: Cell;
  selected: boolean;
  selectCell: (a: number, b: number) => void;
  conflicts: boolean;
  isNotesMode: boolean;
};
...
function groupCellsByBlock(grid: Cell[][]) {
...
export default function SudokuBoard() {
  ...
  const [board, setBoard] = useState<Board>(new Board(mode));
